...
from gym_pull.versioning.config_parser import parse_config
...
The repository must have a ".openai.yml" in its top-level folder on its master branch.""")
        ...
        logger.info('Downloading configuration file "%s/%s/master/%s"', username, repository, github_yaml_file)
        try:
